...
import 'rotation_sensor_implementation_stub.dart'
    if (dart.library.js_interop_unsafe) 'rotation_sensor_implementation_web.dart';
...
class RotationSensor {
  ...
  static String get implementation =>
      describeRotationSensorPlatform(RotationSensorPlatform.instance);
